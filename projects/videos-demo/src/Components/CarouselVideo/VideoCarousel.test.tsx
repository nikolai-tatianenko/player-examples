...
import ReactPlayerCarousel, { ImageType } from './ReactPlayerCarousel';

describe('ReactPlayerCarousel', () => {
  ...
  it('renders without errors', () => {
    render(<ReactPlayerCarousel images={images} options={options} />);
  });

  it('displays the first image as selected by default', () => {
    const { getByTestId } = render(
      <ReactPlayerCarousel images={images} options={options} />
    );
